"""Data models for CallTrail. The UI never knows how tools work — it uses these."""
...
from calltrail.outcomes import ExecutionResult
from calltrail.diagnostics import Diagnostic

from calltrail.changes import ChangedFile
from calltrail.impact import AffectedCommand
