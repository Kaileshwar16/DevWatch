...
from calltrail.preflight import CommandPreflight
from pathlib import Path

from calltrail.config import CallTrailConfig, command_args
from calltrail.detectors.language import detect_languages, detect_node_manager
from calltrail.metadata import read_json, read_toml
from calltrail.scopes import project_scopes
from calltrail.canonical import canonical_commands
...
def discover_commands(root: Path, config: CallTrailConfig) -> dict[str, Command]:
        ...
        try:
            ...
            if test:
                provenance = ("Cargo.toml" if test[0] == "cargo" else
                              ...
                              "CallTrail heuristic (Go)" if test[0] == "go" else "CallTrail heuristic (Python)")
