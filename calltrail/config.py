"""Validated, opt-in project commands and services from .calltrail.toml."""
...
class CallTrailConfig:
    ...
    @classmethod
    def load(cls, project_root: Path) -> CallTrailConfig:
        path = project_root / ".calltrail.toml"
        try:
