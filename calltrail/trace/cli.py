...
from calltrail.trace.presentation import format_trace, trace_data
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(prog='calltrail trace', description='Explore possible static Python call relationships.')
    ...
    try:
        ...
        if args.json:
            ...
            print(f'calltrail trace: {exc}', file=sys.stderr)
        return 2
