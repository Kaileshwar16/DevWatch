...
from calltrail.trace.models import SymbolLocation, SymbolRef, TraceIndex
from calltrail.trace.source import IndexLimits, read_source, source_files
...
class PythonAstProvider:
    ...
    def _link(self, index: TraceIndex, files: list[ParsedFile]):
        from calltrail.trace.entries import detect_entries
        from calltrail.trace.resolution import Resolver
